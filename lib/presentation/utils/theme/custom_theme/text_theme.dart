...
class AppTextTheme{
  ...
  static TextTheme lightTextTheme =  TextTheme(
   ...
   bodyLarge: const TextStyle().copyWith(fontFamily: 'Poppins',fontSize: 14.0,fontWeight: FontWeight.w500,color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith(fontFamily: 'Poppins',fontSize: 12.0,fontWeight: FontWeight.w500,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme =  TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontFamily: 'Poppins',fontSize: 14.0,fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.5)),

    labelLarge: const TextStyle().copyWith(fontFamily: 'Poppins',fontSize: 12.0,fontWeight: FontWeight.normal,color: Colors.white),
    labelMedium: const TextStyle().copyWith(fontFamily: 'Poppins',fontSize: 12.0,fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.5)),
